...
import com.jjak0b.android.trackingmypantry.data.PantryDB;
...
public class PantryRepository {
    ...
    public LiveData<List<ProductWithTags>> getProductsWithTags( ProductFilterState filter ){
        if( filter == null ){
    ...
    public LiveData<List<PlaceWithPurchases>> getAllPurchaseInfo(@NonNull String productID) {
